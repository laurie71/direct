...
var Ctx = require('./controllers').ActionContext;
var Ref = require('./controllers').ActionReference;
...
routes.Route = lib.inherit(Object, {
    ...
    handle: function(req, res, next) {
        ...
        if (! this.handler) {
            this.handler = this.controller.resolve(this.action);
        }
        // this.handler(req, res, next);
        var ctx = new Ctx(req, res, next);
        this.handler(ctx);
    },
