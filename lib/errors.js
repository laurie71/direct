...
var captureStack = util.error.addStack;
...
// error.DirectError = util.inherit(Error, {
//     name: null,
//     title: null,
//     details: '',
//     
...
// error.SourceError = util.inherit(error.DirectError, { // XXX refactor: remove in favour of ParseError
...
// error.FileError = util.inherit(error.DirectError, {
...
// });
// 
// error.MissingFileError = util.inherit(error.FileError, {
...
// });
// 
// error.ParseError = util.inherit(error.FileError, {
